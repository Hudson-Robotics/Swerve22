...
public class Robot extends TimedRobot {
 ...
 // private final I2C.Port i2cPort = I2C.Port.kOnboard;
   ...
   */
  /*
   * private final CANSparkMax indexTop = new CANSparkMax(10,
   * MotorType.kBrushless);
   * private final CANSparkMax indexBottom = new CANSparkMax(11,
   * MotorType.kBrushless);
   */
  /*
   * private final CANSparkMax shooterAngle = new CANSparkMax(5,
   * MotorType.kBrushless);
  ...
  /*
   * private final DoubleSolenoid climbCylinders = PnueHub.makeDoubleSolenoid(0,
   * 1);
   * private final DoubleSolenoid intLeftCylinders = PnueHub.makeDoubleSolenoid(2,
   * 3);
   * private final DoubleSolenoid intRightCylinders =
   * PnueHub.makeDoubleSolenoid(6, 7);
   */
